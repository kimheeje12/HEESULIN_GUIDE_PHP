...
<body>
    ...
    <div class="mainimage">
        ...
        <table>
            ...
            $sql2 = mq("SELECT * FROM qa_board order by qa_board_idx asc limit $start_num, $list");
        ...
        <div id="last">
            <form action="search_result.php" method="get">
                ...
                <input type="text" name="search" size="15" required="required" style="font-size:30px;"/> <button style="font-size:25px; width:100px; border-radius: 30px; ">검색</button>
            </form>
        </div>
    </div>
</body>
