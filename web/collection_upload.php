...
<body>
    ...
    <form class="maintext" form method="POST" action="collection_write.php" enctype="multipart/form-data">
        <h1 style="font-size: 50px; margin-top: 25%;"> Collection Upload</h1>
        <h1>Title</h1>
        <p><textarea name="title" cols=20 rows=2 placeholder="Title" style= "font-size: 25px; text-align:center;"></textarea></p>
        <h1>Address</h1>
        <input type="text" name="address" placeholder="Address" style="width:450px; height:130px; font-size: 25px; text-align:center;" readonly />
        <button type="button" style="width:100px; height:50px; font-size: 20px; border-radius: 30px;" onclick="openZipSearch()">검색</button>
        <h1>Price</h1>
        <p><textarea name="price" cols=15 rows=1 placeholder="Price" style= "font-size: 30px; text-align:center;"></textarea></p>
        <h1>Opinion</h1>
        <textarea name="opinion" cols=25 rows=8 placeholder="Opinion" style= "font-size: 25px; text-align:center;"></textarea>
        <br>
